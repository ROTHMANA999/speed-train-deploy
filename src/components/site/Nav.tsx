    ...
    <header className="sticky top-0 z-50 border-b border-white/5 bg-navy-deep/85 backdrop-blur-md">
      <div className="container-page flex h-16 items-center justify-between gap-4">
        <Link to="/" className="flex min-w-0 items-center gap-3">
          <div className="grid size-9 shrink-0 rotate-45 place-items-center rounded-sm bg-gold">
            <span className="-rotate-45 font-display text-[11px] font-bold tracking-tighter text-navy-deep">CSAT</span>
          </div>
          <div className="hidden min-w-0 leading-tight sm:block">
            <div className="truncate text-[11px] font-bold uppercase tracking-widest text-foreground">
              Cambodian Speed Accurate
            </div>
            <div className="khmer truncate text-[10px] text-gold">ខេមបូឌាន ស្ពីជ អាកឃ្យូរ៉េត</div>
          </div>
        </Link>
